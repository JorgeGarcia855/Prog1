...
public class EmpleadoDAO {
	...
	public void borrarEmpleado(EmpleadoDTO empleado) {
		empleados.remove(empleado.getId());
		System.out.println("Empleado "+empleado.getId()+" eliminado satisfactoriamente");
	}
	...
	public void actualizarEmpleado(EmpleadoDTO empleado) {
		...
		System.out.println("Empleado id: "+ empleado.getId()+" actualizado satisfactoriamente");	
	}
