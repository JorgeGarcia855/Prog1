...
public class PanelHombres extends JPanel {
	...
	private JTextField jcorreo, jnombrecompleto, jalias, jestatura, jingresosmes, japellido1, japellido2;
	private JLabel jldisponible, jlcorreo, jlnombrecompleto, jlalias, jlestatura, jlingresosmes, jlingreso, h_titulo,
	...
	public void inicializarComponentes() {
		...
		h_titulo = new JLabel("Inscripción Hombres");
		...
		jlingresosmes = new JLabel("Ingresos : ");
		jlestatura.setFont(new Font("Calibri", 30, 15));
		jlingresosmes.setBounds(280, 140, 100, 20);
		add(jlingresosmes);

		jingresosmes = new JTextField();
		jingresosmes.setBounds(345, 140, 100, 20);
		jingresosmes.setBorder(new LineBorder(null));
		jingresosmes.setEditable(true);
		add(jingresosmes);
		...
		b_verificar.setActionCommand("VERIFICARHOMBRES");
	...
	public JTextField getJingresosmes() {
		return jingresosmes;
	}

	public void setJingresosmes(JTextField jingresosmes) {
		this.jingresosmes = jingresosmes;
	}
	...
	public JLabel getJlingresosmes() {
		return jlingresosmes;
	}

	public void setJlingresosmes(JLabel jlingresosmes) {
		this.jlingresosmes = jlingresosmes;
	}
