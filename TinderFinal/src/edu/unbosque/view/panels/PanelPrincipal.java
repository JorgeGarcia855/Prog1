...
public class PanelPrincipal extends JPanel {
	...
	public void inicializarComponentes() {
		...
		e_titulo = new JLabel("BOSTINDER");
		e_titulo.setForeground(Color.white);
		e_titulo.setFont(new Font("Algerian", 30, 50));
		e_titulo.setBounds(115, 100, 264, 45);
		add(e_titulo);
